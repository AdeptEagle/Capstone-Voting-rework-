...
async function testPositionInitialization() {
  try {
    ...
    // Clear existing positions first (in correct order due to foreign keys)
    ...
    // Now simulate what the PositionInitializationService would do
