...
-- This migration adds soft delete functionality to candidates, positions, departments, courses, and elections
...
-- Add soft delete fields to elections table
...
CREATE INDEX "idx_elections_is_deleted" ON "elections"("is_deleted");
...
CREATE INDEX "idx_elections_deleted_at" ON "elections"("deleted_at");
