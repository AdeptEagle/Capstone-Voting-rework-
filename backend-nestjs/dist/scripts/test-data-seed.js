...
async function seedTestData() {
    ...
    try {
        ...
        const now = new Date();
        const startDate1 = new Date(now.getTime() + 1000);
        const endDate1 = new Date(now.getTime() + 24 * 60 * 60 * 1000);
        const startDate2 = new Date(now.getTime() + 2 * 1000);
        ...
        await Promise.all([
            prisma.ballotPosition.create({
                data: {
                    ...
                    BallotPosition_PositionId: positions[0].id,
            ...
            prisma.ballotPosition.create({
                data: {
                    id: generateId(),
                    BallotPosition_BallotId: ballot1.id,
                    BallotPosition_PositionId: positions[1].id,
        ...
        await Promise.all([
            prisma.ballotPosition.create({
                data: {
                    ...
                    BallotPosition_PositionId: positions[2].id,
                    BallotPosition_DisplayOrder: 1,
                    BallotPosition_IsRequired: true,
                },
            }),
            prisma.ballotPosition.create({
                data: {
                    id: generateId(),
                    BallotPosition_BallotId: ballot2.id,
                    BallotPosition_PositionId: positions[3].id,
                    BallotPosition_DisplayOrder: 2,
                    BallotPosition_IsRequired: true,
                },
            }),
        ...
        await Promise.all([
            prisma.ballotCandidate.create({
                data: {
                    ...
                    BallotCandidate_CandidateId: candidates[0].id,
            ...
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot1.id,
                    BallotCandidate_CandidateId: candidates[1].id,
                    BallotCandidate_PositionId: positions[0].id,
                    BallotCandidate_IsActive: true,
                },
            }),
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot1.id,
                    BallotCandidate_CandidateId: candidates[2].id,
            ...
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot1.id,
                    BallotCandidate_CandidateId: candidates[3].id,
                    BallotCandidate_PositionId: positions[1].id,
                    BallotCandidate_IsActive: true,
                },
            }),
        ...
        await Promise.all([
            prisma.ballotCandidate.create({
                data: {
                    ...
                    BallotCandidate_CandidateId: candidates[4].id,
            ...
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot2.id,
                    BallotCandidate_CandidateId: candidates[5].id,
                    BallotCandidate_PositionId: positions[2].id,
                    BallotCandidate_IsActive: true,
                },
            }),
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot2.id,
                    BallotCandidate_CandidateId: candidates[6].id,
                    BallotCandidate_PositionId: positions[2].id,
                    BallotCandidate_IsActive: true,
                },
            }),
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot2.id,
                    BallotCandidate_CandidateId: candidates[7].id,
            ...
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot2.id,
                    BallotCandidate_CandidateId: candidates[8].id,
                    BallotCandidate_PositionId: positions[3].id,
                    BallotCandidate_IsActive: true,
                },
            }),
            prisma.ballotCandidate.create({
                data: {
                    id: generateId(),
                    BallotCandidate_BallotId: ballot2.id,
                    BallotCandidate_CandidateId: candidates[9].id,
                    BallotCandidate_PositionId: positions[3].id,
                    BallotCandidate_IsActive: true,
                },
            }),
...
//# sourceMappingURL=test-data-seed.js.map