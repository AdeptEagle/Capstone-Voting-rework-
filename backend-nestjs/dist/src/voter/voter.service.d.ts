...
export declare class VoterService {
    ...
    constructor(prisma: PrismaService, idGenerator: IdGeneratorService, votingGateway: VotingGateway);
    ...
    getVoterBallotHistory(voterId: string): Promise<{
        voter: {
            id: string;
            name: string;
            studentId: string;
    ...
    getVoterVotingDetails(voterId: string): Promise<{
        voter: {
            id: string;
            name: string;
            studentId: string;
