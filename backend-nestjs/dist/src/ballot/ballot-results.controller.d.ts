...
export declare class BallotResultsController {
    private readonly ballotResultsService;
    constructor(ballotResultsService: BallotResultsService);
    getBallotsWithResults(req: any): Promise<({
        ballotPositions: ({
            position: {
                id: string;
                createdAt: Date;
    ...
    getBallotResults(id: string): Promise<{
        ballotPositions: ({
            position: {
                id: string;
                createdAt: Date;
    ...
    getLiveBallotResults(id: string): Promise<{
        ballotPositions: ({
            position: {
                id: string;
                createdAt: Date;
    ...
    refreshBallotResults(id: string): Promise<{
        id: string;
        BallotResults_BallotId: string;
        BallotResults_TotalVotes: number;
        BallotResults_TotalVoters: number;
    ...
    getPartylistResults(id: string): Promise<any[]>;
    getBallotAnalytics(id: string): Promise<{
        basicStats: {
            totalVotes: number;
            totalVoters: number;
            voterTurnout: number;
